              ...
              onTap: () async {
                if (Get.find<RideController>().tripDetail?.currentStatus ==
                  ...
                  await launchUrl(Uri.parse(
                      'google.navigation:q=${Get.find<RideController>().tripDetail!.pickupCoordinates!.coordinates![1].toString()}, ${Get.find<RideController>().tripDetail!.pickupCoordinates!.coordinates![0].toString()}&key=${AppConstants.polylineMapKey}'));
                } else {
                  await launchUrl(Uri.parse(
