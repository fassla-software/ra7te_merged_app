...
import 'package:ride_sharing_user_app/lib2/common_widgets/custom_radio_button.dart';
      ...
      children: [
        ...
        GetBuilder<TripController>(builder: (tripController) {
          int length = widget.isOngoing
              ? tripController
                  .rideCancellationCauseList!.data!.ongoingRide!.length
              : tripController
                  .rideCancellationCauseList!.data!.acceptedRide!.length;
          return Container(
              ...
              itemBuilder: (context, index) {
                return CustomRadioButton(
                  text: widget.isOngoing
                      ? tripController
                          .rideCancellationCauseList!.data!.ongoingRide![index]
                      : tripController.rideCancellationCauseList!.data!
                          .acceptedRide![index],
                  isSelected:
                      tripController.rideCancellationCurrentIndex == index,
                  onTap: () {
