...
import 'package:ride_sharing_user_app/lib2/helper/support_chat_helper.dart';
...
class AdminConversationBubbleWidget extends StatefulWidget {
  ...
  @override
  State<AdminConversationBubbleWidget> createState() =>
      _AdminConversationBubbleWidgetState();
}

class _AdminConversationBubbleWidgetState
    extends State<AdminConversationBubbleWidget> {
  List<String> images = [];
  ...
  Widget build(BuildContext context) {
    bool isSameUserWithPreviousMessage = Get.find<HelpAndSupportController>()
        .isSameUserWithPreviousMessage(widget.previousMessage, widget.message);
    bool isSameUserWithNextMessage = Get.find<HelpAndSupportController>()
        .isSameUserWithNextMessage(widget.message, widget.nextMessage);
    images = [];
    ...
    return Column(
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              if ((widget.length - 1 == widget.index)) ...[
                Center(
                    child: Text(
                  SupportChatHelper.chatTimeCalculation(
                  ...
                  (widget.message.user!.id! ==
                      ...
                      : Column(children: [
                          ClipRRect(
                            ...
                            child: (isSameUserWithNextMessage &&
                                ...
                                : ImageWidget(
                                    ...
                                    width: 30,
                                    image:
                                        '${Get.find<SplashController>().config!.imageBaseUrl!.profileImageAdmin}/${widget.message.user!.profileImage}',
                            ...
                            decoration: BoxDecoration(
                              color: (widget.message.user!.id! ==
                                  ...
                                  : Theme.of(context)
                                      .primaryColor
                                      .withOpacity(0.08),
                              borderRadius: (widget.message.user!.id! ==
                                      Get.find<ProfileController>().driverId)
                                  ? calculateRadiusForDriver(
                                      isSameUserWithNextMessage,
                                      isSameUserWithPreviousMessage)
                                  : calculateRadiusForAdmin(
                                      isSameUserWithNextMessage,
                                      isSameUserWithPreviousMessage),
                            ),
                            child: Padding(
                                              ...
                                              child: Column(children: [
                                                Row(children: [
                                                  ...
                                                  Column(children: [
                                                    ...
                                                    Text(
                                                        '${widget.message.conversationFiles![index].fileSize}',
                                                        maxLines: 5,
                                                        overflow:
                                                            TextOverflow.clip,
                                                        style: textRegular
        ...
        if (!SupportChatHelper.isMessageSameDate(
            widget.message.createdAt!, widget.previousMessage?.createdAt))
          Center(
              child: Text(
  ...
  BorderRadius calculateRadiusForDriver(
      bool isSameUserWithNextMessage, bool isSameUserWithPreviousMessage) {
    if (Get.find<LocalizationController>().isLtr) {
      return isSameUserWithNextMessage && isSameUserWithPreviousMessage
          ? BorderRadius.only()
          : isSameUserWithNextMessage
              ? BorderRadius.only(
  ...
  BorderRadius calculateRadiusForAdmin(
      bool isSameUserWithNextMessage, bool isSameUserWithPreviousMessage) {
    if (Get.find<LocalizationController>().isLtr) {
      return isSameUserWithNextMessage && isSameUserWithPreviousMessage
          ? BorderRadius.only()
