...
import 'package:ride_sharing_user_app/lib2/common_widgets/divider_widget.dart';
...
import 'package:ride_sharing_user_app/lib2/features/wallet/widgets/pending_withdrawn_bottomsheet_widget.dart';
      ...
      child: GetBuilder<WalletController>(builder: (walletController) {
        return InkWell(
          ...
          child: Column(children: [
            ...
            DividerWidget(
                height: .5, color: Theme.of(context).hintColor.withOpacity(.75))
          ]),
        );
      }),
    );
