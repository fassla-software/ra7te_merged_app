...
import 'package:ride_sharing_user_app/lib2/features/auth/widgets/text_field_title_widget.dart';
...
import 'package:ride_sharing_user_app/lib2/common_widgets/date_picker_widget.dart';
            ...
            child:
              ...
              profileController.creating
                  ...
                  : ButtonWidget(
                      ...
                      buttonText:
                          widget.vehicleInfo == null ? 'save'.tr : 'update'.tr,
                      onPressed: () {
                        ...
                        String expireDate = profileController.dateFormat
                            .format(
                                profileController.startDate ?? DateTime.now())
                            .toString();
